...
export function ReportCard({ report }: { report: Report }) {
  ...
  return (
    <div
      ...
      className="bg-card border rounded-xl p-4 hover:shadow-elevated transition-all duration-200 cursor-pointer group"
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">{report.fileName}</p>
